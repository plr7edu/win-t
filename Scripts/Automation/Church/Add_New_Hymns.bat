...
::Start Directory Opus
START C:\"Program Files"\GPSoftware\"Directory Opus"\dopus.exe

::Start FastStone Capture
START C:\"Program Files (x86)"\"FastStone Capture"\FSCapture.exe

::Start Keethunu Gee Potha 2 PDF
START D:\CHRUCH\"Chruch Presentation Folder"\"3  - Hymns"\PDF\"Kethunu Gee Potha 2.pdf"
